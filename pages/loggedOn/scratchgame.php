...
<!-- main section -->
<main class="main-section logged-in scratchgame" role="container">
        ...
        >
          <div class="left-section">
            <p class="fw-bold bold-text">
              Our fabulous scratchcard collection
            </p>
            <p class="fw-medium text-left w-md-100 w-lg-75 mt-3 small-text">
              A collection of classic games <br />and new additions
            </p>
          </div>
          <div class="right-section">
            <img src="../../assets/images/scratch.png" alt="gold image" />
          </div>
        </div>
      </div>
    </div>

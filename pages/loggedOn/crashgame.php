...
<!-- main section -->
<main class="main-section logged-in crashgame" role="container">
      ...
      <div class="d-flex justify-content-center position-relative">
        ...
        >
          <div class="left-section">
            <p class="fw-bold bold-text">The most diverse offer</p>
            <p class="fw-medium text-left w-md-100 w-lg-75 mt-3 small-text">
              Have fun with our incredible <br />Selection!
            </p>
          </div>
          <div class="right-section">
            <img src="../../assets/images/crash.png" alt="gold image" />
          </div>
        </div>
      </div>
    </div>

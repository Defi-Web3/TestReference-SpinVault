...
<!-- main section -->
<main class="main-section logged-in bingo" role="container">
        ...
        >
          <div class="left-section">
            <p class="fw-bold bold-text">
              Experience Bingo as never before
            </p>
            <p class="fw-medium text-left w-md-100 w-lg-75 mt-3 small-text">
              An electrifying Bingo journey <br />Unparallel entertainment
              experience
            </p>
          </div>
          <div class="right-section">
            <img src="../../assets/images/bingo.png" alt="gold image" />
          </div>
        </div>
      </div>
    </div>

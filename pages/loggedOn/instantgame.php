...
<!-- main section -->
<main class="main-section logged-in instantgame" role="container">
      ...
      <div class="d-flex justify-content-center position-relative">
        ...
        >
          <div class="left-section">
            <p class="fw-bold bold-text">Best instant game collection</p>
            <p class="fw-medium text-left w-md-100 w-lg-75 mt-3 small-text">
              Get ready for some serious fun and let the good <br />times
              roll across any device
            </p>
          </div>
          <div class="right-section">
            <img src="../../assets/images/lottery.png" alt="gold image" />
          </div>
        </div>
      </div>
    </div>
